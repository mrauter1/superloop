...
## Required actions
1. Update `.superloop/tasks/fix-phase-local-gaps/implement/phases/<phase-dir-key>/criteria.md` checkboxes accurately.
2. Append prioritized review findings to `.superloop/tasks/fix-phase-local-gaps/implement/phases/<phase-dir-key>/feedback.md` with stable IDs (for example `IMP-001`).
...
## Rules
- Do not modify non-`.superloop/tasks/fix-phase-local-gaps/` code files.
