...
- The authoritative active phase artifact files injected in the run preamble, especially:
  `.superloop/tasks/fix-phase-local-gaps/implement/phases/<phase-dir-key>/feedback.md`
- `.superloop/tasks/fix-phase-local-gaps/plan/plan.md`
- `.superloop/tasks/fix-phase-local-gaps/implement/phases/<phase-dir-key>/implementation_notes.md`
...
8. Treat the active phase contract as authoritative scoped work for implement/test runs. Any intentional out-of-phase change must be explicitly justified in `.superloop/tasks/fix-phase-local-gaps/implement/phases/<phase-dir-key>/implementation_notes.md`.
9. Map your edits to the implementation checklist in `.superloop/tasks/fix-phase-local-gaps/plan/plan.md` when present, and note any checklist item you intentionally defer.
10. Update `.superloop/tasks/fix-phase-local-gaps/implement/phases/<phase-dir-key>/implementation_notes.md` with: files changed, checklist mapping, assumptions, expected side effects, and any deduplication/centralization decisions.
...
12. Do not edit `.superloop/tasks/fix-phase-local-gaps/implement/phases/<phase-dir-key>/criteria.md` (reviewer-owned).
