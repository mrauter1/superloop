...
## Required actions
1. Update `.superloop/tasks/fix-phase-local-gaps/test/phases/<phase-dir-key>/criteria.md` checkboxes accurately.
2. Append prioritized audit findings to `.superloop/tasks/fix-phase-local-gaps/test/phases/<phase-dir-key>/feedback.md` with stable IDs (for example `TST-001`).
...
## Rules
- Do not edit repository code except `.superloop/tasks/fix-phase-local-gaps/test/*` audit artifacts.
