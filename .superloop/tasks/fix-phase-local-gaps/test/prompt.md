...
- Update `.superloop/tasks/fix-phase-local-gaps/test/phases/<phase-dir-key>/test_strategy.md` with an explicit behavior-to-test coverage map.
- Append a concise entry to `.superloop/tasks/fix-phase-local-gaps/test/phases/<phase-dir-key>/feedback.md` summarizing test additions.
...
8. Do not edit `.superloop/tasks/fix-phase-local-gaps/test/phases/<phase-dir-key>/criteria.md` (auditor-owned).
