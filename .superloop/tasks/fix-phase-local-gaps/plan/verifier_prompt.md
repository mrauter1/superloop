...
## Required actions
1. Update `.superloop/tasks/fix-phase-local-gaps/plan/criteria.md` checkboxes accurately.
2. Append prioritized findings to `.superloop/tasks/fix-phase-local-gaps/plan/feedback.md` with stable IDs (for example `PLAN-001`).
