...
- `.superloop/tasks/prd-phase-local/implement/feedback.md`
- `.superloop/tasks/prd-phase-local/plan/plan.md`
- `.superloop/tasks/prd-phase-local/implement/implementation_notes.md`
...
8. Treat the active phase contract as authoritative scoped work for implement/test runs. Any intentional out-of-phase change must be explicitly justified in `.superloop/tasks/prd-phase-local/implement/implementation_notes.md`.
9. Map your edits to the implementation checklist in `.superloop/tasks/prd-phase-local/plan/plan.md` when present, and note any checklist item you intentionally defer.
10. Update `.superloop/tasks/prd-phase-local/implement/implementation_notes.md` with: files changed, checklist mapping, assumptions, expected side effects, and any deduplication/centralization decisions.
...
12. Do not edit `.superloop/tasks/prd-phase-local/implement/criteria.md` (reviewer-owned).
